...
export const fallbackAboutData: { data: AboutPageData } = {
    data: {
        ...
        vision: {
            ...
            quote: "Melalui visi ini, Perseroan berkomitmen untuk memperkuat kehadiran pasarnya sambil menciptakan nilai berkelanjutan bagi semua pemangku kepentingan.",
            list: [
        ...
        mission: {
            ...
            quote: "Melalui misi ini, Perseroan bertujuan untuk secara konsisten memberikan nilai, membangun kepercayaan, dan mendukung pertumbuhan jangka panjang bagi pelanggan, mitra, dan pemangku kepentingan.",
            list: [
        ...
        boc: {
            badge: "Dewan Komisaris Kami",
            title: "Dewan Komisaris (BOC)",
        ...
        bod: {
            badge: "Dewan Direksi Kami",
            title: "Dewan Direksi (BOD)",
        ...
        metadata: {
            title: "Tentang Kami",
            description: "Temukan warisan keunggulan Apollo Global Interactive. Pelajari visi kami untuk mobilitas berkelanjutan, tim kepemimpinan yang berdedikasi, dan komitmen kami terhadap inovasi otomotif.",

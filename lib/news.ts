...
export async function fetchInvestorNews(lang: string): Promise<InvestorNewsSectionData> {
	const isId = lang === "id";
	const staticHeader = {
		badge: isId ? "Berita" : "News",
		title: isId ? "Berita Terbaru" : "Latest News",
		desc: isId
			? "Berita terbaru dari perusahaan kami, termasuk inovasi produk, manufaktur, wawasan industri, dan pencapaian utama"
			: "Latest news from our company, including product innovation, manufacturing, industry insights, and key achievements.",
	};

					...
					<div className="flex flex-col gap-6">
						...
						<div className="flex flex-col gap-4 mt-4">
							{dataDisplay.map((item, idx) => (
								<div
									key={idx}
									className="flex items-center gap-4 p-4 rounded-2xl bg-gray-50 border border-gray-100 transition-all hover:shadow-md"
								>
									<div
									...
									/>
									<div>
										<h4 className="font-semibold text-[#323441]">
											{item.name}
										</h4>
					...
					<div className="flex flex-row gap-6 justify-center items-center flex-wrap">
						...
						<div className="relative w-[280px] h-[280px] flex flex-col items-center justify-center">
								...
								<ResponsiveContainer width="100%" height="100%">
									<PieChart>
										<Pie
											...
											paddingAngle={-5}
										>
											<Cell fill={dataDisplay[0].color} />{" "}
											{/* Majority Color */}
											<Cell fill="#f1f5f9" />{" "}
											{/* Remaining is gray/empty color, or public color if full pie? Design shows two separate rings. */}
							...
							<div className="text-center z-10">
								<span className="block text-4xl font-bold text-[#323441]">
									{majorityPercent}%
								</span>

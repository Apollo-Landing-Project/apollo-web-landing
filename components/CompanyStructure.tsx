			...
			<div className="flex flex-col items-center text-center px-4">
				...
				<div className="relative w-full max-w-6xl">
					...
					<div className="hidden lg:block relative w-full h-8 mb-6">
						...
						{/* <div className="absolute top-0 left-[16.66%] h-full w-px bg-gray-300 none"></div> */}
					...
					{primaryDepartment && (
						<div className="mt-8 flex justify-center lg:mt-0">
							<div className="flex w-full max-w-[320px] flex-col items-center justify-center gap-5 rounded-[24px] border-[0.5px] border-[rgba(177,177,177,0.2)] bg-white p-[24px] text-center shadow-[8px_4px_24px_0px_rgba(177,177,177,0.12)] transition-transform hover:-translate-y-1 lg:p-[32px]">
								<div className="flex h-[60px] w-[60px] items-center justify-center overflow-hidden rounded-[8px] border-[0.5px] border-[#f2f2f7] bg-[#f2f7ff] text-[#5a80b9] lg:h-[70px] lg:w-[70px]">
									<Car size={32} strokeWidth={1.5} />
								</div>
								<span className="text-center text-[16px] font-bold leading-tight text-[#323441] md:text-[18px] lg:text-[20px]">
                    ...
                    <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-3 lg:gap-8 mt-8 lg:mt-0">
						{items.map((dept, index) => {
							const DepartmentIcon =
								departments[index % departments.length].icon;
							return (
								<div
									key={dept.id || index}
									className="flex items-center justify-center gap-[18px] bg-white border-[0.5px] border-[rgba(177,177,177,0.2)] p-[20px] lg:p-[28px] rounded-[24px] shadow-[8px_4px_24px_0px_rgba(177,177,177,0.12)] transition-transform hover:-translate-y-1"
								>
